...
template<class _Base> struct _Non_trivial_copy : _Base { // non-trivial copy construction facade
  using _Base::_Base;
...
template<class _Base> struct _Deleted_copy : _Base { // deleted copy construction facade
  using _Base::_Base;
...
template<class _Base, class... _Types> using _SMF_control_copy = conditional_t<
  conjunction_v<is_trivially_copy_constructible<_Types>...>, _Base,
  conditional_t<conjunction_v<is_copy_constructible<_Types>...>, _Non_trivial_copy<_Base>, _Deleted_copy<_Base>>>;

template<class _Base, class... _Types> struct _Non_trivial_move
  : _SMF_control_copy<_Base, _Types...> { // non-trivial move construction facade
...
template<class _Base, class... _Types> struct _Deleted_move
  : _SMF_control_copy<_Base, _Types...> { // deleted move construction facade
  using _Mybase = _SMF_control_copy<_Base, _Types...>;
  using _Mybase::_Mybase;
...
template<class _Base, class... _Types> using _SMF_control_move =
...
template<class _Base, class... _Types> struct _Non_trivial_copy_assign
  : _SMF_control_move<_Base, _Types...> { // non-trivial copy assignment facade
...
template<class _Base, class... _Types> struct _Deleted_copy_assign
  : _SMF_control_move<_Base, _Types...> { // deleted copy assignment facade
  using _Mybase = _SMF_control_move<_Base, _Types...>;
  using _Mybase::_Mybase;
...
template<class _Base, class... _Types> using _SMF_control_copy_assign =
...
template<class _Base, class... _Types> struct _Non_trivial_move_assign
  : _SMF_control_copy_assign<_Base, _Types...> { // non-trivial move assignment facade
  ...
  _CONSTEXPR20 _Non_trivial_move_assign&
  operator=(_Non_trivial_move_assign&& _That) noexcept(noexcept(_Mybase::_Assign_from(static_cast<_Base&&>(_That)))) {
    _Mybase::_Assign_from(static_cast<_Base&&>(_That));
    return *this;
  }
};

template<class _Base, class... _Types> struct _Deleted_move_assign
  : _SMF_control_copy_assign<_Base, _Types...> { // deleted move assignment facade
  using _Mybase = _SMF_control_copy_assign<_Base, _Types...>;
  using _Mybase::_Mybase;
...
template<class _Base, class... _Types> using _SMF_control_move_assign =
...
template<class _Base, class... _Types> using _SMF_control = _SMF_control_move_assign<_Base, _Types...>;
