...
//        inline int __cdecl _iswprint_l (_In_ wint_t _C, _In_opt_ _locale_t) { return iswctype(_C, _BLANK | _PUNCT |
//        _ALPHA | _DIGIT); } inline int __cdecl _iswgraph_l (_In_ wint_t _C, _In_opt_ _locale_t) { return iswctype(_C,
//        _PUNCT | _ALPHA | _DIGIT); } inline int __cdecl _iswcntrl_l (_In_ wint_t _C, _In_opt_ _locale_t) { return
