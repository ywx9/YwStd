...
#define _malloca(size)                                                                                              \
  __pragma(warning(suppress : 6255 6386))(                                                                          \
    _MallocaComputeSize(size) != 0 ? _MarkAllocaS(malloc(_MallocaComputeSize(size)), _ALLOCA_S_HEAP_MARKER) : NULL)
#endif
...
#define _malloca(size)                                                                                              \
  __pragma(warning(suppress : 6255 6386))(                                                                          \
    _MallocaComputeSize(size) != 0 ? (((_MallocaComputeSize(size) <= _ALLOCA_S_THRESHOLD)                           \
