...
#endif // ]
#if _USE_ATTRIBUTES_FOR_SAL &&                                                                     \
  (!defined(_MSC_EXTENSIONS) || defined(MIDL_PASS) || defined(__midl) || defined(RC_INVOKED)) // [
#undef _USE_ATTRIBUTES_FOR_SAL
#define _USE_ATTRIBUTES_FOR_SAL 0
#endif // ]
...
#define _Inout_updates_to_(size, count)                                                        \
  _SAL2_Source_(_Inout_updates_to_, (size, count),                                             \
                _Out_writes_to_(size, count) _Pre_valid_impl_ _Pre1_impl_(__count_impl(size)))
#define _Inout_updates_to_opt_(size, count)                                                        \
  _SAL2_Source_(_Inout_updates_to_opt_, (size, count),                                             \
                _Out_writes_to_opt_(size, count) _Pre_valid_impl_ _Pre1_impl_(__count_impl(size)))
...
#define _Inout_updates_bytes_to_(size, count)                                                            \
  _SAL2_Source_(_Inout_updates_bytes_to_, (size, count),                                                 \
                _Out_writes_bytes_to_(size, count) _Pre_valid_impl_ _Pre1_impl_(__bytecount_impl(size)))
#define _Inout_updates_bytes_to_opt_(size, count)                                                            \
  _SAL2_Source_(_Inout_updates_bytes_to_opt_, (size, count),                                                 \
                _Out_writes_bytes_to_opt_(size, count) _Pre_valid_impl_ _Pre1_impl_(__bytecount_impl(size)))
...
#define _Outptr_result_maybenull_ \
  _SAL2_Source_(_Outptr_result_maybenull_, (), _Out_impl_ _Deref_post2_impl_(__maybenull_impl_notref, __count_impl(1)))
#define _Outptr_opt_                                                                                         \
...
#define _Outptr_result_buffer_(size) \
  _SAL2_Source_(_Outptr_result_buffer_, (size), _Out_impl_ _Deref_post2_impl_(__notnull_impl_notref, __cap_impl(size)))
...
#define _Ret_writes_z_(size) \
  _SAL2_Source_(_Ret_writes_z_, (size), _Ret3_impl_(__notnull_impl, __count_impl(size), __zterm_impl) _Ret_valid_impl_)
...
#define _Out_bytecapcount_(capcount) \
  _SAL1_1_Source_(_Out_bytecapcount_, (capcount), _Pre_bytecap_(capcount) _Post_valid_impl_ _Post_bytecount_(capcount))
...
#define _Out_opt_z_capcount_(capcount) \
  _SAL1_1_Source_(_Out_opt_z_capcount_, (capcount), _Pre_opt_cap_(capcount) _Post_valid_impl_ _Post_z_count_(capcount))
...
#define _Deref_pre_cap_(size) \
  _SAL1_1_Source_(_Deref_pre_cap_, (size), _Deref_pre1_impl_(__notnull_impl_notref) _Deref_pre1_impl_(__cap_impl(size)))
...
#define _Ret_opt_bytecap_c_(size) \
  _SAL1_1_Source_(_Ret_opt_bytecap_c_, (size), _Ret1_impl_(__maybenull_impl_notref) _Ret1_impl_(__bytecap_c_impl(size)))
...
#define _Ret_opt_bytecap_x_(size) \
  _SAL1_1_Source_(_Ret_opt_bytecap_x_, (size), _Ret1_impl_(__maybenull_impl_notref) _Ret1_impl_(__bytecap_x_impl(size)))
...
#define _Pre_opt_bytecap_c_(size) \
  _SAL1_1_Source_(_Pre_opt_bytecap_c_, (size), _Pre1_impl_(__maybenull_impl_notref) _Pre1_impl_(__bytecap_c_impl(size)))
...
#define _Pre_opt_bytecap_x_(size) \
  _SAL1_1_Source_(_Pre_opt_bytecap_x_, (size), _Pre1_impl_(__maybenull_impl_notref) _Pre1_impl_(__bytecap_x_impl(size)))
...
#define _Post_z_bytecount_c_(size) \
  _SAL1_1_Source_(_Post_z_bytecount_c_, (size), _Post2_impl_(__zterm_impl, __bytecount_c_impl(size)) _Post_valid_impl_)
...
#define _Post_z_bytecount_x_(size) \
  _SAL1_1_Source_(_Post_z_bytecount_x_, (size), _Post2_impl_(__zterm_impl, __bytecount_x_impl(size)) _Post_valid_impl_)
...
#define __deref_opt_out_ecount_z_opt(size) \
  _SAL1_Source_(__deref_opt_out_ecount_z_opt, (size), __deref_opt_out_ecount_opt(size) __post __deref __nullterminated)
#define __deref_opt_out_bcount_z_opt(size) \
  _SAL1_Source_(__deref_opt_out_bcount_z_opt, (size), __deref_opt_out_bcount_opt(size) __post __deref __nullterminated)
...
#define __control_entrypoint(category)                                                   \
  _SAL_L_Source_(__control_entrypoint, (category), __inner_control_entrypoint(category))
...
#define _Analysis_noreturn_ _SAL2_Source_(_Analysis_noreturn_, (), _SA_annotes0(SAL_terminates))
  ...
  __AnalysisAssumeNullterminated(_Post_ _Null_terminated_ const void* p);
...
#define _Analysis_mode_(mode)                                                                           \
  __pragma(warning(disable : 28110 28111 28161 28162)) typedef _Analysis_mode_impl_(mode) int __GENSYM( \
...
#define _Maybe_raises_SEH_exception_                                                     \
  _SAL2_Source_(_Maybe_raises_SEH_exception_, (x), _Pre_ _SA_annotes1(SAL_inTry, __yes))
#define _Raises_SEH_exception_                                                                 \
  _SAL2_Source_(_Raises_SEH_exception_, (x), _Maybe_raises_SEH_exception_ _Analysis_noreturn_)
...
_Internal_create_CSAL_identifier_(_Lock_kind_mutex_) _Internal_create_CSAL_identifier_(_Lock_kind_event_)
  _Internal_create_CSAL_identifier_(_Lock_kind_semaphore_) _Internal_create_CSAL_identifier_(_Lock_kind_spin_lock_)
...
#define _Requires_lock_held_(lock)                                                              \
  _SAL2_Source_(_Requires_lock_held_, (lock), _Pre_ _SA_annotes1(SAL_requires_lock_held, lock))
#define _Requires_exclusive_lock_held_(lock)                                                                        \
  _SAL2_Source_(_Requires_exclusive_lock_held_, (lock), _Pre_ _SA_annotes1(SAL_requires_exclusive_lock_held, lock))
#define _Requires_shared_lock_held_(lock)                                                                     \
  _SAL2_Source_(_Requires_shared_lock_held_, (lock), _Pre_ _SA_annotes1(SAL_requires_shared_lock_held, lock))

#define _Requires_lock_not_held_(lock)                                                                  \
  _SAL2_Source_(_Requires_lock_not_held_, (lock), _Pre_ _SA_annotes1(SAL_requires_lock_not_held, lock))
#define _Requires_no_locks_held_                                                              \
  _SAL2_Source_(_Requires_no_locks_held_, (), _Pre_ _SA_annotes0(SAL_requires_no_locks_held))
...
#define _Acquires_exclusive_lock_(lock)                                                                    \
  _SAL2_Source_(_Acquires_exclusive_lock_, (lock), _Post_ _SA_annotes1(SAL_acquires_exclusive_lock, lock))
#define _Acquires_shared_lock_(lock)                                                                 \
  _SAL2_Source_(_Acquires_shared_lock_, (lock), _Post_ _SA_annotes1(SAL_acquires_shared_lock, lock))

#define _Releases_lock_(lock) _SAL2_Source_(_Releases_lock_, (lock), _Post_ _SA_annotes1(SAL_releases_lock, lock))
#define _Releases_exclusive_lock_(lock)                                                                    \
  _SAL2_Source_(_Releases_exclusive_lock_, (lock), _Post_ _SA_annotes1(SAL_releases_exclusive_lock, lock))
#define _Releases_shared_lock_(lock)                                                                 \
  _SAL2_Source_(_Releases_shared_lock_, (lock), _Post_ _SA_annotes1(SAL_releases_shared_lock, lock))

/*
 * acquire/release locking side effects for non-reentrant locks
 */
#define _Acquires_nonreentrant_lock_(lock)                                                                  \
  _SAL2_Source_(_Acquires_nonreentrant_lock_, (lock), _Requires_lock_not_held_(lock) _Acquires_lock_(lock))

#define _Releases_nonreentrant_lock_(lock)                                                              \
  _SAL2_Source_(_Releases_nonreentrant_lock_, (lock), _Requires_lock_held_(lock) _Releases_lock_(lock))
...
#define _Internal_lock_level_order_(a, b)                                                      \
  _SAL2_Source_(_Internal_lock_level_order_, (a, b), _SA_annotes2(SAL_lock_level_order, a, b))
...
#define _Internal_set_lock_count_to_zero_(lock)                                                                  \
  _SAL2_Source_(Internal_set_lock_count_to_zero_, (lock), _Post_ _SA_annotes1(SAL_set_lock_count_to_zero, lock))
#define _Internal_set_lock_count_to_one_(lock)                                                                  \
  _SAL2_Source_(_Internal_set_lock_count_to_one_, (lock), _Post_ _SA_annotes1(SAL_set_lock_count_to_one, lock))
...
#define _Function_ignore_lock_checking_(lock)                                                             \
  _SAL2_Source_(_Function_ignore_lock_checking_, (lock), _Pre_ _SA_annotes1(SAL_ignore_lock_match, lock))
...
#define _Benign_race_begin_                                                                            \
  __pragma(warning(push)) __pragma(warning(disable : 26100 26101 26150 26130 26180 26131 26181 28112))
#define _Benign_race_end_ __pragma(warning(pop))

#define _No_competing_thread_begin_                                                                      \
  __pragma(warning(push))                                                                                \
    __pragma(warning(disable : 26100 26101 26150 26101 26151 26110 26160 26130 26180 26131 26181 28112))
...
extern "C++" {
template<class _SmartLockType>
_Acquires_lock_(_smartLock) void _Internal_acquires_smart_lock_(const _SmartLockType& _smartLock);
template<class _SmartLockType>
_Releases_lock_(_smartLock) void _Internal_releases_smart_lock_(const _SmartLockType& _smartLock);
} // extern "C++"
...
#define _Detaches_lock_(detached, lock)                                                             \
  _Post_same_lock_(_Internal_swap_lock_, (lock)) _Post_same_lock_((detached), _Internal_swap_lock_)
#define _Moves_lock_(target, source)                                                                \
  _Post_same_lock_(_Internal_swap_lock_, (source)) _Post_same_lock_((target), _Internal_swap_lock_)
#define _Replaces_lock_(target, source)                                                 \
  _Post_same_lock_(_Internal_swap_lock_, (target)) _Post_same_lock_((target), (source)) \
    _Releases_lock_(_Internal_swap_lock_)
#define _Swaps_locks_(left, right)                                                 \
  _Post_same_lock_(_Internal_swap_lock_, (left)) _Post_same_lock_((left), (right)) \
    _Post_same_lock_((right), _Internal_swap_lock_)
...
#define __requires_lock_held(lock)                                                                \
  _SAL1_1_Source_(__requires_lock_held, (lock), __pre _SA_annotes1(SAL_requires_lock_held, lock))
#define __requires_exclusive_lock_held(lock)                                                                          \
  _SAL1_1_Source_(__requires_exclusive_lock_held, (lock), __pre _SA_annotes1(SAL_requires_exclusive_lock_held, lock))
#define __requires_shared_lock_held(lock)                                                                       \
  _SAL1_1_Source_(__requires_shared_lock_held, (lock), __pre _SA_annotes1(SAL_requires_shared_lock_held, lock))

#define __requires_lock_not_held(lock)                                                                    \
  _SAL1_1_Source_(__requires_lock_not_held, (lock), __pre _SA_annotes1(SAL_requires_lock_not_held, lock))
#define __requires_no_locks_held                                                                \
  _SAL1_1_Source_(__requires_no_locks_held, (), __pre _SA_annotes0(SAL_requires_no_locks_held))
...
#define __acquires_exclusive_lock(lock)                                                                      \
  _SAL1_1_Source_(__acquires_exclusive_lock, (lock), __post _SA_annotes1(SAL_acquires_exclusive_lock, lock))
#define __acquires_shared_lock(lock)                                                                   \
  _SAL1_1_Source_(__acquires_shared_lock, (lock), __post _SA_annotes1(SAL_acquires_shared_lock, lock))
...
#define __releases_exclusive_lock(lock)                                                                      \
  _SAL1_1_Source_(__releases_exclusive_lock, (lock), __post _SA_annotes1(SAL_releases_exclusive_lock, lock))
#define __releases_shared_lock(lock)                                                                   \
  _SAL1_1_Source_(__releases_shared_lock, (lock), __post _SA_annotes1(SAL_releases_shared_lock, lock))
...
#define __has_lock_property(kind)                                                          \
  _SAL1_1_Source_(__has_lock_property, (kind), _SA_annotes1(SAL_has_lock_property, #kind))
...
#define __internal_lock_level_order(a, b)                                                          \
  _SAL1_1_Source_(__internal_lock_level_order, (a, b), _SA_annotes2(SAL_lock_level_order, #a, #b))
...
#define __function_ignore_lock_checking(lock)                                                              \
  _SAL1_1_Source_(__function_ignore_lock_cleanup, (lock), __pre _SA_annotes1(SAL_ignore_lock_match, lock))
...
#define NO_COMPETING_THREAD_BEGIN                                                                                  \
  __pragma(warning(push)) __pragma(warning(disable : 26100 26150 26101 26151 26110 26160 26130 26180 26131 26181))
