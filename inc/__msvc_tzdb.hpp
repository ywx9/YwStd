...
_NODISCARD __std_tzdb_sys_info* __stdcall __std_tzdb_get_sys_info(const char* _Tz, size_t _Tz_len,
                                                                  __std_tzdb_epoch_milli _Local) noexcept;
void __stdcall __std_tzdb_delete_sys_info(__std_tzdb_sys_info* _Info) noexcept;

_NODISCARD __std_tzdb_leap_info* __stdcall __std_tzdb_get_leap_seconds(size_t _Prev_ls_size,
                                                                       size_t* _Current_ls_size) noexcept;
...
template<class _Ty> struct _Tzdb_deleter;

template<> struct _Tzdb_deleter<__std_tzdb_time_zones_info> {
...
template<> struct _Tzdb_deleter<__std_tzdb_current_zone_info> {
...
template<> struct _Tzdb_deleter<__std_tzdb_sys_info> {
...
template<> struct _Tzdb_deleter<__std_tzdb_leap_info[]> {
...
template<class _Ty> class _Crt_allocator {
public:
  ...
  template<class _Other> constexpr _Crt_allocator(const _Crt_allocator<_Other>&) noexcept {}
  ...
  void deallocate(_Ty* const _Ptr, size_t) noexcept { __std_free_crt(_Ptr); }

  template<class _Other> _NODISCARD bool operator==(const _Crt_allocator<_Other>&) const noexcept { return true; }
};
