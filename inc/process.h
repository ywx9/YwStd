...
int __stdcall _CRT_INIT(_In_ void* _DllHandle, _In_ unsigned long _Reason, _In_opt_ void* _Reserved);
...
_ACRTIMP uintptr_t __cdecl _beginthread(_In_ _beginthread_proc_type _StartAddress, _In_ unsigned _StackSize,
                                        _In_opt_ void* _ArgList);

_ACRTIMP void __cdecl _endthread(void);

_Success_(return != 0) _ACRTIMP uintptr_t
  __cdecl _beginthreadex(_In_opt_ void* _Security, _In_ unsigned _StackSize,
                         _In_ _beginthreadex_proc_type _StartAddress, _In_opt_ void* _ArgList, _In_ unsigned _InitFlag,
...
_DCRTIMP intptr_t __cdecl _execve(_In_z_ char const* _FileName, _In_z_ char const* const* _Arguments,
...
_DCRTIMP intptr_t __cdecl _execvpe(_In_z_ char const* _FileName, _In_z_ char const* const* _Arguments,
                                   _In_opt_z_ char const* const* _Environment);
...
_DCRTIMP intptr_t __cdecl _spawnve(_In_ int _Mode, _In_z_ char const* _FileName, _In_z_ char const* const* _Arguments,
                                   _In_opt_z_ char const* const* _Environment);

_DCRTIMP intptr_t __cdecl _spawnvp(_In_ int _Mode, _In_z_ char const* _FileName, _In_z_ char const* const* _Arguments);

_DCRTIMP intptr_t __cdecl _spawnvpe(_In_ int _Mode, _In_z_ char const* _FileName, _In_z_ char const* const* _Arguments,
                                    _In_opt_z_ char const* const* _Environment);
...
_DCRTIMP _GetDllProcAddrProcType __cdecl _getdllprocaddr(_In_ intptr_t _Handle, _In_opt_z_ char* _ProcedureName,
...
_DCRTIMP intptr_t __cdecl execve(_In_z_ char const* _FileName, _In_z_ char const* const* _Arguments,
                                 _In_opt_z_ char const* const* _Environment);
...
_DCRTIMP intptr_t __cdecl execvpe(_In_z_ char const* _FileName, _In_z_ char const* const* _Arguments,
                                  _In_opt_z_ char const* const* _Environment);
...
_DCRTIMP intptr_t __cdecl spawnve(_In_ int _Mode, _In_z_ char const* _FileName, _In_z_ char const* const* _Arguments,
                                  _In_opt_z_ char const* const* _Environment);
...
_DCRTIMP intptr_t __cdecl spawnvpe(_In_ int _Mode, _In_z_ char const* _FileName, _In_z_ char const* const* _Arguments,
                                   _In_opt_z_ char const* const* _Environment);
