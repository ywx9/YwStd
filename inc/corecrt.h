...
#define _UCRT_DISABLED_WARNINGS                                                                                       \
  4324 _UCRT_DISABLED_WARNING_4412 4514 4574 4710 4793 4820 4995 4996 28719 28726 28727 _UCRT_EXTRA_DISABLED_WARNINGS
#endif
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
#ifdef _DEBUG
_ACRTIMP void __cdecl _invalid_parameter(_In_opt_z_ wchar_t const*, _In_opt_z_ wchar_t const*,
                                         _In_opt_z_ wchar_t const*, _In_ unsigned int, _In_ uintptr_t);
#endif
...
#else
#define _CRT_NONSTDC_DEPRECATE(_NewName)                                                      \
  _CRT_DEPRECATE_TEXT("The POSIX name for this item is deprecated. Instead, use the ISO C "   \
...
#else
#define _CRT_OBSOLETE(_NewItem)                                                          \
  _CRT_DEPRECATE_TEXT("This function or variable has been superceded by newer library "  \
...
#define __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_0(_ReturnType, _FuncName, _DstType, _Dst)                              \
  extern "C++" {                                                                                                   \
  template<size_t _Size> inline _ReturnType __CRTDECL _FuncName(_DstType (&_Dst)[_Size]) _CRT_SECURE_CPP_NOTHROW { \
...
#define __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_2(_ReturnType, _FuncName, _DstType, _Dst, _TType1, _TArg1, _TType2, \
                                              _TArg2)                                                           \
  extern "C++" {                                                                                                \
  template<size_t _Size> inline _ReturnType __CRTDECL _FuncName(_DstType (&_Dst)[_Size], _TType1 _TArg1,        \
                                                                _TType2 _TArg2) _CRT_SECURE_CPP_NOTHROW {       \
    return _FuncName(_Dst, _Size, _TArg1, _TArg2);                                                              \
  }                                                                                                             \
  }

#define __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_3(_ReturnType, _FuncName, _DstType, _Dst, _TType1, _TArg1, _TType2, \
...
#define __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_4(_ReturnType, _FuncName, _DstType, _Dst, _TType1, _TArg1, _TType2, \
...
#define __DEFINE_CPP_OVERLOAD_SECURE_FUNC_1_1(_ReturnType, _FuncName, _HType1, _HArg1, _DstType, _Dst, _TType1, \
                                              _TArg1)                                                           \
  extern "C++" {                                                                                                \
  template<size_t _Size> inline _ReturnType __CRTDECL _FuncName(_HType1 _HArg1, _DstType (&_Dst)[_Size],        \
                                                                _TType1 _TArg1) _CRT_SECURE_CPP_NOTHROW {       \
    return _FuncName(_HArg1, _Dst, _Size, _TArg1);                                                              \
  }                                                                                                             \
  }

#define __DEFINE_CPP_OVERLOAD_SECURE_FUNC_1_2(_ReturnType, _FuncName, _HType1, _HArg1, _DstType, _Dst, _TType1, \
...
#define __DEFINE_CPP_OVERLOAD_SECURE_FUNC_1_3(_ReturnType, _FuncName, _HType1, _HArg1, _DstType, _Dst, _TType1, \
...
#define __DEFINE_CPP_OVERLOAD_SECURE_FUNC_2_0(_ReturnType, _FuncName, _HType1, _HArg1, _HType2, _HArg2, _DstType,  \
                                              _Dst)                                                                \
  extern "C++" {                                                                                                   \
  template<size_t _Size> inline _ReturnType __CRTDECL _FuncName(_HType1 _HArg1, _HType2 _HArg2,                    \
                                                                _DstType (&_Dst)[_Size]) _CRT_SECURE_CPP_NOTHROW { \
    return _FuncName(_HArg1, _HArg2, _Dst, _Size);                                                                 \
  }                                                                                                                \
  }

#define __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_1_ARGLIST(_ReturnType, _FuncName, _VFuncName, _DstType, _Dst, _TType1, \
                                                      _TArg1)                                                      \
  extern "C++" {                                                                                                   \
  template<size_t _Size>                                                                                           \
  inline _ReturnType __CRTDECL _FuncName(_DstType (&_Dst)[_Size], _TType1 _TArg1, ...) _CRT_SECURE_CPP_NOTHROW {   \
...
#define __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_2_ARGLIST(_ReturnType, _FuncName, _VFuncName, _DstType, _Dst, _TType1, \
                                                      _TArg1, _TType2, _TArg2)                                     \
  extern "C++" {                                                                                                   \
  template<size_t _Size> inline _ReturnType __CRTDECL _FuncName(_DstType (&_Dst)[_Size], _TType1 _TArg1,           \
                                                                _TType2 _TArg2, ...) _CRT_SECURE_CPP_NOTHROW {     \
...
#define __DEFINE_CPP_OVERLOAD_SECURE_FUNC_SPLITPATH(_ReturnType, _FuncName, _DstType, _Src)                          \
  ...
  inline _ReturnType __CRTDECL _FuncName(_In_z_ _DstType const* _Src, _Post_z_ _DstType (&_Drive)[_DriveSize],       \
                                         _Post_z_ _DstType (&_Dir)[_DirSize], _Post_z_ _DstType (&_Name)[_NameSize], \
                                         _Post_z_ _DstType (&_Ext)[_ExtSize]) _CRT_SECURE_CPP_NOTHROW {              \
...
#define __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_0(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _SalAttributeDst, \
                                                _DstType, _Dst)                                                     \
  __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_0_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _FuncName##_s,       \
                                             _SalAttributeDst, _DstType, _Dst)

#define __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_1(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _SalAttributeDst, \
  ...
  __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_1_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _FuncName##_s,       \
                                             _DstType, _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1)

#define __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_2(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _SalAttributeDst, \
                                                _DstType, _Dst, _TType1, _TArg1, _TType2, _TArg2)                   \
  __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_2_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _FuncName##_s,       \
                                             _DstType, _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1, _TType2,  \
                                             _TArg2)

#define __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_3(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _SalAttributeDst, \
                                                _DstType, _Dst, _TType1, _TArg1, _TType2, _TArg2, _TType3, _TArg3)  \
  __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_3_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _FuncName##_s,       \
                                             _DstType, _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1, _TType2,  \
                                             _TArg2, _TType3, _TArg3)

#define __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_4(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _SalAttributeDst, \
                                                _DstType, _Dst, _TType1, _TArg1, _TType2, _TArg2, _TType3, _TArg3,  \
                                                _TType4, _TArg4)                                                    \
  __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_4_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _FuncName##_s,       \
                                             _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1, _TType2, _TArg2,    \
                                             _TType3, _TArg3, _TType4, _TArg4)

#define __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_1_1(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _HType1, _HArg1,     \
                                                _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1)                     \
  __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_1_1_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _FuncName##_s, _HType1, \
                                             _HArg1, _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1)

#define __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_2_0(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _HType1, _HArg1,     \
                                                _HType2, _HArg2, _SalAttributeDst, _DstType, _Dst)                     \
  __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_2_0_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _FuncName##_s, _HType1, \
                                             _HArg1, _HType2, _HArg2, _SalAttributeDst, _DstType, _Dst)

#define __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_1_ARGLIST(_ReturnType, _ReturnPolicy, _DeclSpec, _CC, _FuncName,         \
                                                        _VFuncName, _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1) \
  __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_1_ARGLIST_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _CC, _FuncName,            \
                                                     _FuncName##_s, _VFuncName, _VFuncName##_s, _SalAttributeDst,      \
                                                     _DstType, _Dst, _TType1, _TArg1)

#define __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_2_ARGLIST(_ReturnType, _ReturnPolicy, _DeclSpec, _CC, _FuncName,         \
                                                        _VFuncName, _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1, \
                                                        _TType2, _TArg2)                                               \
  __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_2_ARGLIST_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _CC, _FuncName,            \
                                                     _VFuncName, _VFuncName##_s, _DstType, _SalAttributeDst, _DstType, \
                                                     _Dst, _TType1, _TArg1, _TType2, _TArg2)

#define __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_2_SIZE(_DeclSpec, _FuncName, _SalAttributeDst, _DstType, _Dst, _TType1, \
                                                     _TArg1, _TType2, _TArg2)                                         \
  __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_2_SIZE_EX(_DeclSpec, _FuncName, _FuncName##_s, _DstType, _SalAttributeDst,    \
                                                  _DstType, _Dst, _TType1, _TArg1, _TType2, _TArg2)

#define __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_3_SIZE(_DeclSpec, _FuncName, _SalAttributeDst, _DstType, _Dst, _TType1, \
                                                     _TArg1, _TType2, _TArg2, _TType3, _TArg3)                        \
  __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_3_SIZE_EX(_DeclSpec, _FuncName, _FuncName##_s, _DstType, _SalAttributeDst,    \
                                                  _DstType, _Dst, _TType1, _TArg1, _TType2, _TArg2, _TType3, _TArg3)

#define __DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_0(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _SalAttributeDst, \
                                                 _DstType, _Dst)                                                     \
  __DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_0_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _FuncName##_s,       \
                                              _SalAttributeDst, _DstType, _Dst)

#define __DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_1(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _SalAttributeDst, \
                                                 _DstType, _Dst, _TType1, _TArg1)                                    \
  __DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_1_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _FuncName##_s,       \
                                              _SalAttributeDst, _DstType, _DstType, _Dst, _TType1, _TArg1)

#define __DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_2(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _SalAttributeDst, \
                                                 _DstType, _Dst, _TType1, _TArg1, _TType2, _TArg2)                   \
  __DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_2_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _FuncName##_s,       \
                                              _DstType, _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1, _TType2,  \
                                              _TArg2)

#define __DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_3(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _SalAttributeDst, \
                                                 _DstType, _Dst, _TType1, _TArg1, _TType2, _TArg2, _TType3, _TArg3)  \
  __DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_3_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _FuncName##_s,       \
                                              _DstType, _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1, _TType2,  \
                                              _TArg2, _TType3, _TArg3)

#define __DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_4(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _SalAttributeDst, \
                                                 _DstType, _Dst, _TType1, _TArg1, _TType2, _TArg2, _TType3, _TArg3,  \
                                                 _TType4, _TArg4)                                                    \
  __DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_4_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _FuncName##_s,       \
                                              _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1, _TType2, _TArg2,    \
                                              _TType3, _TArg3, _TType4, _TArg4)

#define __DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_1_1(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _HType1, _HArg1, \
                                                 _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1)                 \
  __DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_1_1_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _FuncName##_s,      \
                                              _HType1, _HArg1, _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1)

#define __DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_2_0(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _HType1, _HArg1, \
                                                 _HType2, _HArg2, _SalAttributeDst, _DstType, _Dst)                 \
  __DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_2_0_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _FuncName##_s,      \
                                              _HType1, _HArg1, _HType2, _HArg2, _SalAttributeDst, _DstType, _Dst)

#define __DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_1_ARGLIST(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _VFuncName, \
                                                         _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1)            \
  __DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_1_ARGLIST_EX(_ReturnType, _ReturnPolicy, _DeclSpec, __cdecl, _FuncName,       \
                                                      _FuncName##_s, _VFuncName, _VFuncName##_s, _SalAttributeDst,     \
                                                      _DstType, _Dst, _TType1, _TArg1)

#define __DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_2_SIZE(_DeclSpec, _FuncName, _SalAttributeDst, _DstType, _Dst, _TType1, \
                                                      _TArg1, _TType2, _TArg2)                                         \
  __DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_2_SIZE_EX(_DeclSpec, _FuncName, _FuncName##_s, _DstType, _SalAttributeDst,    \
                                                   _DstType, _Dst, _TType1, _TArg1, _TType2, _TArg2)

#define __DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_3_SIZE(_DeclSpec, _FuncName, _SalAttributeDst, _DstType, _Dst, _TType1, \
                                                      _TArg1, _TType2, _TArg2, _TType3, _TArg3)                        \
  __DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_3_SIZE_EX(_DeclSpec, _FuncName, _FuncName##_s, _DstType, _SalAttributeDst,    \
                                                   _DstType, _Dst, _TType1, _TArg1, _TType2, _TArg2, _TType3, _TArg3)
...
#define __RETURN_POLICY_VOID(_FunctionCall, _Dst) \
  (_FunctionCall);                                \
  return
#define __EMPTY_DECLSPEC

#define __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_0_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _SecureFuncName, \
                                                   _SalAttributeDst, _DstType, _Dst)                                  \
  ...
  extern "C++" {                                                                                                      \
  template<typename _T> inline _CRT_INSECURE_DEPRECATE(_SecureFuncName) _ReturnType __CRTDECL                         \
    _FuncName(_T& _Dst) _CRT_SECURE_CPP_NOTHROW {                                                                     \
    return __insecure_##_FuncName(static_cast<_DstType*>(_Dst));                                                      \
  }                                                                                                                   \
  template<typename _T> inline _CRT_INSECURE_DEPRECATE(_SecureFuncName) _ReturnType __CRTDECL                         \
    _FuncName(const _T& _Dst) _CRT_SECURE_CPP_NOTHROW {                                                               \
    return __insecure_##_FuncName(static_cast<_DstType*>(_Dst));                                                      \
  }                                                                                                                   \
  template<> inline _CRT_INSECURE_DEPRECATE(_SecureFuncName) _ReturnType __CRTDECL                                    \
    _FuncName(_SalAttributeDst _DstType*& _Dst) _CRT_SECURE_CPP_NOTHROW {                                             \
    return __insecure_##_FuncName(_Dst);                                                                              \
  }                                                                                                                   \
  template<size_t _Size> inline _ReturnType __CRTDECL _FuncName(_DstType (&_Dst)[_Size]) _CRT_SECURE_CPP_NOTHROW {    \
    _ReturnPolicy(_SecureFuncName(_Dst, _Size), _Dst);                                                                \
  }                                                                                                                   \
  template<> inline _CRT_INSECURE_DEPRECATE(_SecureFuncName) _ReturnType __CRTDECL _FuncName<1>(_DstType(&_Dst)[1])   \
    _CRT_SECURE_CPP_NOTHROW {                                                                                         \
    _ReturnPolicy(_SecureFuncName(_Dst, 1), _Dst);                                                                    \
  }                                                                                                                   \
  }

#define __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_0_CGETS(_ReturnType, _DeclSpec, _FuncName, _SalAttributeDst, _DstType, \
                                                      _Dst)                                                          \
  __inline _ReturnType __CRTDECL __insecure_##_FuncName(_SalAttributeDst _DstType* _Dst) {                           \
    _ReturnType __cdecl _FuncName(_SalAttributeDst _DstType* _Dst);                                                  \
    return _FuncName(_Dst);                                                                                          \
  ...
  extern "C++" {                                                                                                     \
  template<typename _T> inline _CRT_INSECURE_DEPRECATE(_FuncName##_s) _ReturnType __CRTDECL                          \
    _FuncName(_T& _Dst) _CRT_SECURE_CPP_NOTHROW {                                                                    \
    return __insecure_##_FuncName(static_cast<_DstType*>(_Dst));                                                     \
  }                                                                                                                  \
  template<typename _T> inline _CRT_INSECURE_DEPRECATE(_FuncName##_s) _ReturnType __CRTDECL                          \
  ...
  template<> inline _CRT_INSECURE_DEPRECATE(_FuncName##_s) _ReturnType __CRTDECL                                     \
    _FuncName(_SalAttributeDst _DstType*& _Dst) _CRT_SECURE_CPP_NOTHROW {                                            \
    return __insecure_##_FuncName(_Dst);                                                                             \
  }                                                                                                                  \
  template<size_t _Size> inline _ReturnType __CRTDECL _FuncName(_DstType (&_Dst)[_Size]) _CRT_SECURE_CPP_NOTHROW {   \
    size_t _SizeRead = 0;                                                                                            \
    errno_t _Err =                                                                                                   \
      _FuncName##_s(_Dst + 2, (_Size - 2) < ((size_t)_Dst[0]) ? (_Size - 2) : ((size_t)_Dst[0]), &_SizeRead);        \
    _Dst[1] = (_DstType)(_SizeRead);                                                                                 \
    return (_Err == 0 ? _Dst + 2 : 0);                                                                               \
  }                                                                                                                  \
  template<> inline _CRT_INSECURE_DEPRECATE(_FuncName##_s) _ReturnType __CRTDECL _FuncName<1>(_DstType(&_Dst)[1])    \
    _CRT_SECURE_CPP_NOTHROW {                                                                                        \
    return __insecure_##_FuncName((_DstType*)_Dst);                                                                  \
  }                                                                                                                  \
  template<> inline _CRT_INSECURE_DEPRECATE(_FuncName##_s) _ReturnType __CRTDECL _FuncName<2>(_DstType(&_Dst)[2])    \
    _CRT_SECURE_CPP_NOTHROW {                                                                                        \
    return __insecure_##_FuncName((_DstType*)_Dst);                                                                  \
  }                                                                                                                  \
  }

#define __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_1_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _SecureFuncName, \
                                                   _SecureDstType, _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1) \
  ...
  extern "C++" {                                                                                                      \
  template<typename _T> inline _CRT_INSECURE_DEPRECATE(_SecureFuncName) _ReturnType __CRTDECL                         \
    _FuncName(_T& _Dst, _TType1 _TArg1) _CRT_SECURE_CPP_NOTHROW {                                                     \
    return __insecure_##_FuncName(static_cast<_DstType*>(_Dst), _TArg1);                                              \
  }                                                                                                                   \
  template<typename _T> inline _CRT_INSECURE_DEPRECATE(_SecureFuncName) _ReturnType __CRTDECL                         \
    _FuncName(const _T& _Dst, _TType1 _TArg1) _CRT_SECURE_CPP_NOTHROW {                                               \
    return __insecure_##_FuncName(static_cast<_DstType*>(_Dst), _TArg1);                                              \
  }                                                                                                                   \
  template<> inline _CRT_INSECURE_DEPRECATE(_SecureFuncName) _ReturnType __CRTDECL                                    \
    _FuncName(_SalAttributeDst _DstType*& _Dst, _TType1 _TArg1) _CRT_SECURE_CPP_NOTHROW {                             \
  ...
  template<> inline _CRT_INSECURE_DEPRECATE(_SecureFuncName)                                                          \
...
#define __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_2_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _SecureFuncName, \
                                                   _SecureDstType, _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1, \
                                                   _TType2, _TArg2)                                                   \
  __inline _ReturnType __CRTDECL __insecure_##_FuncName(_SalAttributeDst _DstType* _Dst, _TType1 _TArg1,              \
                                                        _TType2 _TArg2) _CRT_SECURE_CPP_NOTHROW {                     \
  ...
  extern "C++" {                                                                                                      \
  template<typename _T> inline _CRT_INSECURE_DEPRECATE(_SecureFuncName) _ReturnType __CRTDECL                         \
    _FuncName(_T& _Dst, _TType1 _TArg1, _TType2 _TArg2) _CRT_SECURE_CPP_NOTHROW {                                     \
    return __insecure_##_FuncName(static_cast<_DstType*>(_Dst), _TArg1, _TArg2);                                      \
  }                                                                                                                   \
  template<typename _T> inline _CRT_INSECURE_DEPRECATE(_SecureFuncName) _ReturnType __CRTDECL                         \
    _FuncName(const _T& _Dst, _TType1 _TArg1, _TType2 _TArg2) _CRT_SECURE_CPP_NOTHROW {                               \
    return __insecure_##_FuncName(static_cast<_DstType*>(_Dst), _TArg1, _TArg2);                                      \
  }                                                                                                                   \
  template<> inline _CRT_INSECURE_DEPRECATE(_SecureFuncName) _ReturnType __CRTDECL                                    \
    _FuncName(_SalAttributeDst _DstType*& _Dst, _TType1 _TArg1, _TType2 _TArg2) _CRT_SECURE_CPP_NOTHROW {             \
    return __insecure_##_FuncName(_Dst, _TArg1, _TArg2);                                                              \
  }                                                                                                                   \
  template<size_t _Size> inline _ReturnType __CRTDECL _FuncName(_SecureDstType (&_Dst)[_Size], _TType1 _TArg1,        \
                                                                _TType2 _TArg2) _CRT_SECURE_CPP_NOTHROW {             \
...
#define __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_3_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _SecureFuncName, \
                                                   _SecureDstType, _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1, \
                                                   _TType2, _TArg2, _TType3, _TArg3)                                  \
  __inline _ReturnType __CRTDECL __insecure_##_FuncName(_SalAttributeDst _DstType* _Dst, _TType1 _TArg1,              \
                                                        _TType2 _TArg2, _TType3 _TArg3) {                             \
  ...
  extern "C++" {                                                                                                      \
  template<typename _T> inline _CRT_INSECURE_DEPRECATE(_SecureFuncName) _ReturnType __CRTDECL                         \
    _FuncName(_T& _Dst, _TType1 _TArg1, _TType2 _TArg2, _TType3 _TArg3) _CRT_SECURE_CPP_NOTHROW {                     \
    return __insecure_##_FuncName(static_cast<_DstType*>(_Dst), _TArg1, _TArg2, _TArg3);                              \
  }                                                                                                                   \
  template<typename _T> inline _CRT_INSECURE_DEPRECATE(_SecureFuncName) _ReturnType __CRTDECL                         \
    _FuncName(const _T& _Dst, _TType1 _TArg1, _TType2 _TArg2, _TType3 _TArg3) _CRT_SECURE_CPP_NOTHROW {               \
    return __insecure_##_FuncName(static_cast<_DstType*>(_Dst), _TArg1, _TArg2, _TArg3);                              \
  }                                                                                                                   \
  template<> inline _CRT_INSECURE_DEPRECATE(_SecureFuncName) _ReturnType __CRTDECL                                    \
  ...
  template<> inline _CRT_INSECURE_DEPRECATE(_SecureFuncName) _ReturnType __CRTDECL _FuncName<1>(                      \
    _DstType(&_Dst)[1], _TType1 _TArg1, _TType2 _TArg2, _TType3 _TArg3) _CRT_SECURE_CPP_NOTHROW {                     \
    _ReturnPolicy(_SecureFuncName(_Dst, 1, _TArg1, _TArg2, _TArg3), _Dst);                                            \
  }                                                                                                                   \
  }

#define __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_4_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _SecureFuncName,  \
                                                   _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1, _TType2, _TArg2, \
                                                   _TType3, _TArg3, _TType4, _TArg4)                                   \
  __inline _ReturnType __CRTDECL __insecure_##_FuncName(_SalAttributeDst _DstType* _Dst, _TType1 _TArg1,               \
  ...
  extern "C++" {                                                                                                       \
  template<typename _T> inline _CRT_INSECURE_DEPRECATE(_SecureFuncName) _ReturnType __CRTDECL                          \
    _FuncName(_T& _Dst, _TType1 _TArg1, _TType2 _TArg2, _TType3 _TArg3, _TType4 _TArg4) _CRT_SECURE_CPP_NOTHROW {      \
    return __insecure_##_FuncName(static_cast<_DstType*>(_Dst), _TArg1, _TArg2, _TArg3, _TArg4);                       \
  }                                                                                                                    \
  template<typename _T> inline _CRT_INSECURE_DEPRECATE(_SecureFuncName) _ReturnType __CRTDECL                          \
    _FuncName(const _T& _Dst, _TType1 _TArg1, _TType2 _TArg2, _TType3 _TArg3,                                          \
              _TType4 _TArg4) _CRT_SECURE_CPP_NOTHROW {                                                                \
    return __insecure_##_FuncName(static_cast<_DstType*>(_Dst), _TArg1, _TArg2, _TArg3, _TArg4);                       \
  }                                                                                                                    \
  template<> inline _CRT_INSECURE_DEPRECATE(_SecureFuncName) _ReturnType __CRTDECL                                     \
  ...
  template<> inline _CRT_INSECURE_DEPRECATE(_SecureFuncName) _ReturnType __CRTDECL _FuncName<1>(                       \
    _DstType(&_Dst)[1], _TType1 _TArg1, _TType2 _TArg2, _TType3 _TArg3, _TType4 _TArg4) _CRT_SECURE_CPP_NOTHROW {      \
    _ReturnPolicy(_SecureFuncName(_Dst, 1, _TArg1, _TArg2, _TArg3, _TArg4), _Dst);                                     \
  }                                                                                                                    \
  }

#define __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_1_1_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _SecureFuncName,  \
                                                   _HType1, _HArg1, _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1) \
  __inline _ReturnType __CRTDECL __insecure_##_FuncName(_HType1 _HArg1, _SalAttributeDst _DstType* _Dst,               \
                                                        _TType1 _TArg1) {                                              \
  ...
  extern "C++" {                                                                                                       \
  template<typename _T> inline _CRT_INSECURE_DEPRECATE(_SecureFuncName) _ReturnType __CRTDECL                          \
    _FuncName(_HType1 _HArg1, _T& _Dst, _TType1 _TArg1) _CRT_SECURE_CPP_NOTHROW {                                      \
    return __insecure_##_FuncName(_HArg1, static_cast<_DstType*>(_Dst), _TArg1);                                       \
  }                                                                                                                    \
  template<typename _T> inline _CRT_INSECURE_DEPRECATE(_SecureFuncName) _ReturnType __CRTDECL                          \
    _FuncName(_HType1 _HArg1, const _T& _Dst, _TType1 _TArg1) _CRT_SECURE_CPP_NOTHROW {                                \
    return __insecure_##_FuncName(_HArg1, static_cast<_DstType*>(_Dst), _TArg1);                                       \
  }                                                                                                                    \
  template<> inline _CRT_INSECURE_DEPRECATE(_SecureFuncName) _ReturnType __CRTDECL                                     \
    _FuncName(_HType1 _HArg1, _SalAttributeDst _DstType*& _Dst, _TType1 _TArg1) _CRT_SECURE_CPP_NOTHROW {              \
...
#define __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_2_0_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _SecureFuncName,  \
                                                   _HType1, _HArg1, _HType2, _HArg2, _SalAttributeDst, _DstType, _Dst) \
  __inline _ReturnType __CRTDECL __insecure_##_FuncName(_HType1 _HArg1, _HType2 _HArg2,                                \
                                                        _SalAttributeDst _DstType* _Dst) {                             \
  ...
  extern "C++" {                                                                                                       \
  template<typename _T> inline _CRT_INSECURE_DEPRECATE(_SecureFuncName) _ReturnType __CRTDECL                          \
    _FuncName(_HType1 _HArg1, _HType2 _HArg2, _T& _Dst) _CRT_SECURE_CPP_NOTHROW {                                      \
    return __insecure_##_FuncName(_HArg1, _HArg2, static_cast<_DstType*>(_Dst));                                       \
  }                                                                                                                    \
  template<typename _T> inline _CRT_INSECURE_DEPRECATE(_SecureFuncName) _ReturnType __CRTDECL                          \
    _FuncName(_HType1 _HArg1, _HType2 _HArg2, const _T& _Dst) _CRT_SECURE_CPP_NOTHROW {                                \
    return __insecure_##_FuncName(_HArg1, _HArg2, static_cast<_DstType*>(_Dst));                                       \
  }                                                                                                                    \
  template<> inline _CRT_INSECURE_DEPRECATE(_SecureFuncName) _ReturnType __CRTDECL                                     \
    _FuncName(_HType1 _HArg1, _HType2 _HArg2, _SalAttributeDst _DstType*& _Dst) _CRT_SECURE_CPP_NOTHROW {              \
...
#define __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_1_ARGLIST_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _CC, _FuncName, \
                                                           _SecureFuncName, _VFuncName, _SecureVFuncName,         \
                                                           _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1)     \
  ...
  template<> inline _CRT_INSECURE_DEPRECATE(_SecureFuncName)                                                      \
    ...
    _ReturnPolicy(_SecureVFuncName(_Dst, 1, _TArg1, _ArgList), _Dst);                                             \
                                                                                                                  ...
                                                                                                                  \
  template<typename _T> inline _CRT_INSECURE_DEPRECATE(_SecureVFuncName) _ReturnType __CRTDECL                    \
    _VFuncName(_T& _Dst, _TType1 _TArg1, va_list _ArgList) _CRT_SECURE_CPP_NOTHROW {                              \
    return __insecure_##_VFuncName(static_cast<_DstType*>(_Dst), _TArg1, _ArgList);                               \
  }                                                                                                               \
  template<typename _T> inline _CRT_INSECURE_DEPRECATE(_SecureVFuncName) _ReturnType __CRTDECL                    \
    _VFuncName(const _T& _Dst, _TType1 _TArg1, va_list _ArgList) _CRT_SECURE_CPP_NOTHROW {                        \
    return __insecure_##_VFuncName(static_cast<_DstType*>(_Dst), _TArg1, _ArgList);                               \
  }                                                                                                               \
  template<> inline _CRT_INSECURE_DEPRECATE(_SecureVFuncName) _ReturnType __CRTDECL                               \
    _VFuncName(_SalAttributeDst _DstType*& _Dst, _TType1 _TArg1, va_list _ArgList) _CRT_SECURE_CPP_NOTHROW {      \
    return __insecure_##_VFuncName(_Dst, _TArg1, _ArgList);                                                       \
  }                                                                                                               \
  template<size_t _Size> inline _ReturnType __CRTDECL _VFuncName(_DstType (&_Dst)[_Size], _TType1 _TArg1,         \
                                                                 va_list _ArgList) _CRT_SECURE_CPP_NOTHROW {      \
    _ReturnPolicy(_SecureVFuncName(_Dst, _Size, _TArg1, _ArgList), _Dst);                                         \
  }                                                                                                               \
  template<> inline _CRT_INSECURE_DEPRECATE(_SecureVFuncName) _ReturnType __CRTDECL _VFuncName<1>(                \
    _DstType(&_Dst)[1], _TType1 _TArg1, va_list _ArgList) _CRT_SECURE_CPP_NOTHROW {                               \
    _ReturnPolicy(_SecureVFuncName(_Dst, 1, _TArg1, _ArgList), _Dst);                                             \
  }                                                                                                               \
  }

#define __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_2_ARGLIST_EX(                                                            \
  _ReturnType, _ReturnPolicy, _DeclSpec, _CC, _FuncName, _VFuncName, _SecureVFuncName, _SecureDstType,                 \
  _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1, _TType2, _TArg2)                                                  \
  __inline _ReturnType __CRTDECL __insecure_##_VFuncName(_SalAttributeDst _DstType* _Dst, _TType1 _TArg1,              \
                                                         _TType2 _TArg2, va_list _ArgList) {                           \
  ...
  template<size_t _Size> inline _ReturnType __CRTDECL _FuncName(_SecureDstType (&_Dst)[_Size], _TType1 _TArg1,         \
    ...
    _ReturnPolicy(_SecureVFuncName(_Dst, _Size, _TArg1, _TArg2, _ArgList), _Dst);                                      \
                                                                                                                       ...
                                                                                                                       \
  template<>                                                                                                           \
  inline _CRT_INSECURE_DEPRECATE(_FuncName##_s) _ReturnType __CRTDECL _FuncName<1>(_DstType(&_Dst)[1], _TType1 _TArg1, \
                                                                                   _TType2 _TArg2,                     \
                                                                                   ...) _CRT_SECURE_CPP_NOTHROW {      \
    va_list _ArgList;                                                                                                  \
    __crt_va_start(_ArgList, _TArg2);                                                                                  \
    _ReturnPolicy(_SecureVFuncName(_Dst, 1, _TArg1, _TArg2, _ArgList), _Dst);                                          \
                                                                                                                       ...
                                                                                                                       \
  template<typename _T> inline _CRT_INSECURE_DEPRECATE(_SecureVFuncName) _ReturnType __CRTDECL                         \
    _VFuncName(_T& _Dst, _TType1 _TArg1, _TType2 _TArg2, va_list _ArgList) _CRT_SECURE_CPP_NOTHROW {                   \
    return __insecure_##_VFuncName(static_cast<_DstType*>(_Dst), _TArg1, _TArg2, _ArgList);                            \
  }                                                                                                                    \
  template<typename _T> inline _CRT_INSECURE_DEPRECATE(_SecureVFuncName) _ReturnType __CRTDECL                         \
    _VFuncName(const _T& _Dst, _TType1 _TArg1, _TType2 _TArg2, va_list _ArgList) _CRT_SECURE_CPP_NOTHROW {             \
    return __insecure_##_VFuncName(static_cast<_DstType*>(_Dst), _TArg1, _TArg2, _ArgList);                            \
  }                                                                                                                    \
  template<> inline _CRT_INSECURE_DEPRECATE(_SecureVFuncName) _ReturnType __CRTDECL                                    \
    _VFuncName(_SalAttributeDst _DstType*& _Dst, _TType1 _TArg1, _TType2 _TArg2,                                       \
               va_list _ArgList) _CRT_SECURE_CPP_NOTHROW {                                                             \
    return __insecure_##_VFuncName(_Dst, _TArg1, _TArg2, _ArgList);                                                    \
  }                                                                                                                    \
  template<size_t _Size> inline _ReturnType __CRTDECL _VFuncName(_SecureDstType (&_Dst)[_Size], _TType1 _TArg1,        \
                                                                 _TType2 _TArg2,                                       \
                                                                 va_list _ArgList) _CRT_SECURE_CPP_NOTHROW {           \
    _ReturnPolicy(_SecureVFuncName(_Dst, _Size, _TArg1, _TArg2, _ArgList), _Dst);                                      \
  }                                                                                                                    \
  template<> inline _CRT_INSECURE_DEPRECATE(_SecureVFuncName) _ReturnType __CRTDECL _VFuncName<1>(                     \
    _DstType(&_Dst)[1], _TType1 _TArg1, _TType2 _TArg2, va_list _ArgList) _CRT_SECURE_CPP_NOTHROW {                    \
    _ReturnPolicy(_SecureVFuncName(_Dst, 1, _TArg1, _TArg2, _ArgList), _Dst);                                          \
  }                                                                                                                    \
  }

#define __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_2_SIZE_EX(_DeclSpec, _FuncName, _SecureFuncName, _SecureDstType,        \
                                                        _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1, _TType2,   \
                                                        _TArg2)                                                       \
  ...
  extern "C++" {                                                                                                      \
  template<typename _T> inline _CRT_INSECURE_DEPRECATE(_SecureFuncName) size_t __CRTDECL                              \
    _FuncName(_T& _Dst, _TType1 _TArg1, _TType2 _TArg2) _CRT_SECURE_CPP_NOTHROW {                                     \
    return __insecure_##_FuncName(static_cast<_DstType*>(_Dst), _TArg1, _TArg2);                                      \
  }                                                                                                                   \
  template<typename _T> inline _CRT_INSECURE_DEPRECATE(_SecureFuncName) size_t __CRTDECL                              \
  ...
  template<> inline _CRT_INSECURE_DEPRECATE(_SecureFuncName) size_t __CRTDECL                                         \
    _FuncName(_SalAttributeDst _DstType*& _Dst, _TType1 _TArg1, _TType2 _TArg2) _CRT_SECURE_CPP_NOTHROW {             \
    return __insecure_##_FuncName(_Dst, _TArg1, _TArg2);                                                              \
  }                                                                                                                   \
  template<size_t _Size> inline size_t __CRTDECL _FuncName(_SecureDstType (&_Dst)[_Size], _TType1 _TArg1,             \
                                                           _TType2 _TArg2) _CRT_SECURE_CPP_NOTHROW {                  \
    size_t _Ret = 0;                                                                                                  \
    _SecureFuncName(&_Ret, _Dst, _Size, _TArg1, _TArg2);                                                              \
    return (_Ret > 0 ? (_Ret - 1) : _Ret);                                                                            \
  }                                                                                                                   \
  template<> inline _CRT_INSECURE_DEPRECATE(_SecureFuncName) size_t __CRTDECL _FuncName<1>(                           \
    _DstType(&_Dst)[1], _TType1 _TArg1, _TType2 _TArg2) _CRT_SECURE_CPP_NOTHROW {                                     \
    size_t _Ret = 0;                                                                                                  \
...
#define __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_3_SIZE_EX(_DeclSpec, _FuncName, _SecureFuncName, _SecureDstType,       \
                                                        _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1, _TType2,  \
                                                        _TArg2, _TType3, _TArg3)                                     \
  __inline size_t __CRTDECL __insecure_##_FuncName(_SalAttributeDst _DstType* _Dst, _TType1 _TArg1, _TType2 _TArg2,  \
                                                   _TType3 _TArg3) {                                                 \
...
#define __DECLARE_CPP_OVERLOAD_INLINE_FUNC_0_0_EX(_ReturnType, _ReturnPolicy, _FuncName, _SecureFuncName, \
                                                  _SecureDstType, _DstType, _Dst)                         \
  __inline _ReturnType __CRTDECL __insecure_##_FuncName(_DstType* _Dst)

#define __DEFINE_CPP_OVERLOAD_INLINE_FUNC_0_0_EX(_ReturnType, _ReturnPolicy, _FuncName, _SecureFuncName,            \
                                                 _SecureDstType, _DstType, _Dst)                                    \
  extern "C++" {                                                                                                    \
  template<typename _T> inline _CRT_INSECURE_DEPRECATE(_SecureFuncName) _ReturnType __CRTDECL                       \
    _FuncName(_T& _Dst) _CRT_SECURE_CPP_NOTHROW {                                                                   \
  ...
  template<> inline _CRT_INSECURE_DEPRECATE(_SecureFuncName) _ReturnType __CRTDECL                                  \
    _FuncName(_DstType*& _Dst) _CRT_SECURE_CPP_NOTHROW {                                                            \
    return __insecure_##_FuncName(_Dst);                                                                            \
  }                                                                                                                 \
  template<size_t _Size>                                                                                            \
...
#define __DECLARE_CPP_OVERLOAD_INLINE_FUNC_0_1_EX(_ReturnType, _ReturnPolicy, _FuncName, _SecureFuncName, \
                                                  _SecureDstType, _DstType, _Dst, _TType1, _TArg1)        \
  __inline _ReturnType __CRTDECL __insecure_##_FuncName(_DstType* _Dst, _TType1 _TArg1)

#define __DEFINE_CPP_OVERLOAD_INLINE_FUNC_0_1_EX(_ReturnType, _ReturnPolicy, _FuncName, _SecureFuncName,          \
                                                 _SecureDstType, _DstType, _Dst, _TType1, _TArg1)                 \
  extern "C++" {                                                                                                  \
  template<typename _T> inline _CRT_INSECURE_DEPRECATE(_SecureFuncName) _ReturnType __CRTDECL                     \
    _FuncName(_T& _Dst, _TType1 _TArg1) _CRT_SECURE_CPP_NOTHROW {                                                 \
  ...
  template<> inline _CRT_INSECURE_DEPRECATE(_SecureFuncName) _ReturnType __CRTDECL                                \
    _FuncName(_DstType*& _Dst, _TType1 _TArg1) _CRT_SECURE_CPP_NOTHROW {                                          \
    return __insecure_##_FuncName(_Dst, _TArg1);                                                                  \
  }                                                                                                               \
  template<size_t _Size>                                                                                          \
  inline _ReturnType __CRTDECL _FuncName(_SecureDstType (&_Dst)[_Size], _TType1 _TArg1) _CRT_SECURE_CPP_NOTHROW { \
...
#define __DECLARE_CPP_OVERLOAD_INLINE_FUNC_0_2_EX(_ReturnType, _ReturnPolicy, _FuncName, _SecureFuncName,           \
                                                  _SecureDstType, _DstType, _Dst, _TType1, _TArg1, _TType2, _TArg2) \
  __inline _ReturnType __CRTDECL __insecure_##_FuncName(_DstType* _Dst, _TType1 _TArg1, _TType2 _TArg2)

#define __DEFINE_CPP_OVERLOAD_INLINE_FUNC_0_2_EX(_ReturnType, _ReturnPolicy, _FuncName, _SecureFuncName,             \
                                                 _SecureDstType, _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1,  \
                                                 _TType2, _TArg2)                                                    \
  extern "C++" {                                                                                                     \
  template<typename _T> inline _CRT_INSECURE_DEPRECATE(_SecureFuncName) _ReturnType __CRTDECL                        \
...
#define __DECLARE_CPP_OVERLOAD_INLINE_FUNC_0_3_EX(_ReturnType, _ReturnPolicy, _FuncName, _SecureFuncName,           \
                                                  _SecureDstType, _DstType, _Dst, _TType1, _TArg1, _TType2, _TArg2, \
                                                  _TType3, _TArg3)                                                  \
  __inline _ReturnType __CRTDECL __insecure_##_FuncName(_DstType* _Dst, _TType1 _TArg1, _TType2 _TArg2, _TType3 _TArg3)

#define __DEFINE_CPP_OVERLOAD_INLINE_FUNC_0_3_EX(_ReturnType, _ReturnPolicy, _FuncName, _SecureFuncName,            \
                                                 _SecureDstType, _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1, \
                                                 _TType2, _TArg2, _TType3, _TArg3)                                  \
  extern "C++" {                                                                                                    \
  template<typename _T> inline _CRT_INSECURE_DEPRECATE(_SecureFuncName) _ReturnType __CRTDECL                       \
...
#define __DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_0_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _SecureFuncName, \
                                                    _SalAttributeDst, _DstType, _Dst)                                  \
  __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_0_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _SecureFuncName,        \
                                             _SalAttributeDst, _DstType, _Dst)

#define __DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_0_CGETS(_ReturnType, _DeclSpec, _FuncName, _SalAttributeDst, _DstType, \
                                                       _Dst)                                                          \
  __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_0_CGETS(_ReturnType, _DeclSpec, _FuncName, _SalAttributeDst, _DstType, _Dst)

#define __DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_1_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _SecureFuncName, \
                                                    _SecureDstType, _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1) \
  __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_1_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _SecureFuncName,        \
                                             _SecureDstType, _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1)

#define __DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_2_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _SecureFuncName, \
                                                    _SecureDstType, _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1, \
                                                    _TType2, _TArg2)                                                   \
  __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_2_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _SecureFuncName,        \
                                             _SecureDstType, _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1,        \
                                             _TType2, _TArg2)

#define __DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_3_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _SecureFuncName, \
                                                    _SecureDstType, _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1, \
                                                    _TType2, _TArg2, _TType3, _TArg3)                                  \
  __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_3_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _SecureFuncName,        \
                                             _SecureDstType, _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1,        \
                                             _TType2, _TArg2, _TType3, _TArg3)

#define __DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_4_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _SecureFuncName, \
                                                    _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1, _TType2,        \
                                                    _TArg2, _TType3, _TArg3, _TType4)                                  \
  __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_4_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _SecureFuncName,        \
                                             _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1, _TType2, _TArg2,       \
                                             _TType3, _TArg3, _TType4)

#define __DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_1_1_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _SecureFuncName, \
                                                    _HType1, _HArg1, _SalAttributeDst, _DstType, _Dst, _TType1,        \
                                                    _TArg1)                                                            \
  __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_1_1_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _SecureFuncName,        \
                                             _HType1, _HArg1, _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1)

#define __DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_2_0_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _SecureFuncName, \
                                                    _HType1, _HArg1, _HType2, _HArg2, _SalAttributeDst, _DstType,      \
                                                    _Dst)                                                              \
  __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_2_0_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _SecureFuncName,        \
                                             _HType1, _HArg1, _HType2, _HArg2, _SalAttributeDst, _DstType, _Dst)

#define __DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_1_ARGLIST_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _CC, _FuncName,    \
                                                            _SecureFuncName, _VFuncName, _SecureVFuncName,            \
                                                            _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1)        \
  __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_1_ARGLIST_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _CC, _FuncName,           \
                                                     _SecureFuncName, _VFuncName, _SecureVFuncName, _SalAttributeDst, \
                                                     _DstType, _Dst, _TType1, _TArg1)

#define __DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_2_ARGLIST(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _VFuncName, \
                                                         _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1, _TType2,   \
                                                         _TArg2)                                                       \
  __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_2_ARGLIST(_ReturnType, _ReturnPolicy, _DeclSpec, __cdecl, _FuncName,           \
                                                  _VFuncName, _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1,       \
                                                  _TType2, _TArg2)

#define __DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_2_ARGLIST_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _CC, _FuncName,  \
                                                            _VFuncName, _SecureDstType, _SalAttributeDst, _DstType, \
                                                            _Dst, _TType1, _TArg1, _TType2, _TArg2)                 \
  __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_2_ARGLIST_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _CC, _FuncName,         \
                                                     _VFuncName, _VFuncName##_s, _SecureDstType, _SalAttributeDst,  \
                                                     _DstType, _Dst, _TType1, _TArg1, _TType2, _TArg2)

#define __DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_2_SIZE_EX(_DeclSpec, _FuncName, _SecureFuncName, _SecureDstType,       \
                                                         _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1, _TType2,  \
                                                         _TArg2)                                                      \
  __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_2_SIZE_EX(_DeclSpec, _FuncName, _SecureFuncName, _SecureDstType,              \
                                                  _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1, _TType2, _TArg2)

#define __DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_3_SIZE_EX(_DeclSpec, _FuncName, _SecureFuncName, _SecureDstType,       \
                                                         _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1, _TType2,  \
                                                         _TArg2, _TType3, _TArg3)                                     \
  __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_3_SIZE_EX(_DeclSpec, _FuncName, _SecureFuncName, _SecureDstType,              \
                                                  _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1, _TType2, _TArg2, \
                                                  _TType3, _TArg3)

#define __DECLARE_CPP_OVERLOAD_INLINE_NFUNC_0_0_EX(_ReturnType, _ReturnPolicy, _FuncName, _SecureFuncName, \
                                                   _SecureDstType, _DstType, _Dst)                         \
  __DECLARE_CPP_OVERLOAD_INLINE_FUNC_0_0_EX(_ReturnType, _ReturnPolicy, _FuncName, _SecureFuncName,        \
                                            _SecureDstType _DstType, _Dst)

#define __DEFINE_CPP_OVERLOAD_INLINE_NFUNC_0_0_EX(_ReturnType, _ReturnPolicy, _FuncName, _SecureFuncName,          \
                                                  _SecureDstType, _DstType, _Dst)                                  \
  __DEFINE_CPP_OVERLOAD_INLINE_FUNC_0_0_EX(_ReturnType, _ReturnPolicy, _FuncName, _SecureFuncName, _SecureDstType, \
                                           _DstType, _Dst)

#define __DECLARE_CPP_OVERLOAD_INLINE_NFUNC_0_1_EX(_ReturnType, _ReturnPolicy, _FuncName, _SecureFuncName, \
                                                   _SecureDstType, _DstType, _Dst, _TType1, _TArg1)        \
  __DECLARE_CPP_OVERLOAD_INLINE_FUNC_0_1_EX(_ReturnType, _ReturnPolicy, _FuncName, _SecureFuncName,        \
                                            _SecureDstType _DstType, _Dst, _TType1, _TArg1)

#define __DEFINE_CPP_OVERLOAD_INLINE_NFUNC_0_1_EX(_ReturnType, _ReturnPolicy, _FuncName, _SecureFuncName,          \
                                                  _SecureDstType, _DstType, _Dst, _TType1, _TArg1)                 \
  __DEFINE_CPP_OVERLOAD_INLINE_FUNC_0_1_EX(_ReturnType, _ReturnPolicy, _FuncName, _SecureFuncName, _SecureDstType, \
                                           _DstType, _Dst, _TType1, _TArg1)

#define __DECLARE_CPP_OVERLOAD_INLINE_NFUNC_0_2_EX(_ReturnType, _ReturnPolicy, _FuncName, _SecureFuncName,           \
                                                   _SecureDstType, _DstType, _Dst, _TType1, _TArg1, _TType2, _TArg2) \
  __DECLARE_CPP_OVERLOAD_INLINE_FUNC_0_2_EX(_ReturnType, _ReturnPolicy, _FuncName, _SecureFuncName, _SecureDstType,  \
                                            _DstType, _Dst, _TType1, _TArg1, _TType2, _TArg2)

#define __DEFINE_CPP_OVERLOAD_INLINE_NFUNC_0_2_EX(_ReturnType, _ReturnPolicy, _FuncName, _SecureFuncName,            \
                                                  _SecureDstType, _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1, \
                                                  _TType2, _TArg2)                                                   \
  __DEFINE_CPP_OVERLOAD_INLINE_FUNC_0_2_EX(_ReturnType, _ReturnPolicy, _FuncName, _SecureFuncName, _SecureDstType,   \
                                           _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1, _TType2, _TArg2)

#define __DECLARE_CPP_OVERLOAD_INLINE_NFUNC_0_3_EX(_ReturnType, _ReturnPolicy, _FuncName, _SecureFuncName,           \
                                                   _SecureDstType, _DstType, _Dst, _TType1, _TArg1, _TType2, _TArg2, \
                                                   _TType3, _TArg3)                                                  \
  __DECLARE_CPP_OVERLOAD_INLINE_FUNC_0_3_EX(_ReturnType, _ReturnPolicy, _FuncName, _SecureFuncName, _SecureDstType,  \
                                            _DstType, _Dst, _TType1, _TArg1, _TType2, _TArg2, _TType3, _TArg3)

#define __DEFINE_CPP_OVERLOAD_INLINE_NFUNC_0_3_EX(_ReturnType, _ReturnPolicy, _FuncName, _SecureFuncName,            \
                                                  _SecureDstType, _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1, \
                                                  _TType2, _TArg2, _TType3, _TArg3)                                  \
  __DEFINE_CPP_OVERLOAD_INLINE_FUNC_0_3_EX(_ReturnType, _ReturnPolicy, _FuncName, _SecureFuncName, _SecureDstType,   \
                                           _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1, _TType2, _TArg2,       \
                                           _TType3, _TArg3)
...
#define __DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_1_ARGLIST_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _CC, _FuncName, \
                                                            ...
                                                            _SalAttributeDst, _DstType, _Dst, _TType1, _TArg1)     \
  _CRT_INSECURE_DEPRECATE(_SecureFuncName)                                                                         \
  _DeclSpec _ReturnType _CC _FuncName(_SalAttributeDst _DstType* _Dst, _TType1 _TArg1, ...);                       \
  _CRT_INSECURE_DEPRECATE(_SecureVFuncName)                                                                        \
  _DeclSpec _ReturnType _CC _VFuncName(_SalAttributeDst _DstType* _Dst, _TType1 _TArg1, va_list _Args);
...
#define __DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_2_ARGLIST(_ReturnType, _ReturnPolicy, _DeclSpec, _FuncName, _VFuncName, \
  ...
  _DeclSpec _ReturnType __cdecl _FuncName(_SalAttributeDst _DstType* _Dst, _TType1 _TArg1, _TType2 _TArg2, ...);       \
  _CRT_INSECURE_DEPRECATE(_VFuncName##_s)                                                                              \
  _DeclSpec _ReturnType __cdecl _VFuncName(_SalAttributeDst _DstType* _Dst, _TType1 _TArg1, _TType2 _TArg2,            \
                                           va_list _Args);
...
#define __DEFINE_CPP_OVERLOAD_STANDARD_NFUNC_0_2_ARGLIST_EX(_ReturnType, _ReturnPolicy, _DeclSpec, _CC, _FuncName,  \
                                                            ...
                                                            _Dst, _TType1, _TArg1, _TType2, _TArg2)                 \
  _CRT_INSECURE_DEPRECATE(_FuncName##_s)                                                                            \
  _DeclSpec _ReturnType _CC _FuncName(_SalAttributeDst _DstType* _Dst, _TType1 _TArg1, _TType2 _TArg2, ...);        \
  _CRT_INSECURE_DEPRECATE(_VFuncName##_s)                                                                           \
  _DeclSpec _ReturnType _CC _VFuncName(_SalAttributeDst _DstType* _Dst, _TType1 _TArg1, _TType2 _TArg2, va_list _Args);
...
#define __DECLARE_CPP_OVERLOAD_INLINE_NFUNC_0_0_EX(_ReturnType, _ReturnPolicy, _FuncName, _SecureFuncName, \
                                                   _SecureDstType, _DstType, _Dst)                         \
  _CRT_INSECURE_DEPRECATE(_SecureFuncName)                                                                 \
  __inline _ReturnType __CRTDECL _FuncName(_DstType* _Dst)
...
#define __DECLARE_CPP_OVERLOAD_INLINE_NFUNC_0_1_EX(_ReturnType, _ReturnPolicy, _FuncName, _SecureFuncName, \
                                                   _SecureDstType, _DstType, _Dst, _TType1, _TArg1)        \
  _CRT_INSECURE_DEPRECATE(_SecureFuncName)                                                                 \
  __inline _ReturnType __CRTDECL _FuncName(_DstType* _Dst, _TType1 _TArg1)
...
#define __DECLARE_CPP_OVERLOAD_INLINE_NFUNC_0_2_EX(_ReturnType, _ReturnPolicy, _FuncName, _SecureFuncName,           \
                                                   _SecureDstType, _DstType, _Dst, _TType1, _TArg1, _TType2, _TArg2) \
  _CRT_INSECURE_DEPRECATE(_SecureFuncName)                                                                           \
  __inline _ReturnType __CRTDECL _FuncName(_DstType* _Dst, _TType1 _TArg1, _TType2 _TArg2)
...
#define __DECLARE_CPP_OVERLOAD_INLINE_NFUNC_0_3_EX(_ReturnType, _ReturnPolicy, _FuncName, _SecureFuncName,           \
                                                   ...
                                                   _TType3, _TArg3)                                                  \
  _CRT_INSECURE_DEPRECATE(_SecureFuncName)                                                                           \
  __inline _ReturnType __CRTDECL _FuncName(_DstType* _Dst, _TType1 _TArg1, _TType2 _TArg2, _TType3 _TArg3)
