...
_VCRT_EXPORT_STD class bad_exception : public exception {
public:
...
_VCRT_EXPORT_STD class bad_alloc : public exception {
public:
...
_VCRT_EXPORT_STD class bad_array_new_length : public bad_alloc {
public:
